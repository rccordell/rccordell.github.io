...
date: 2025-04-10
author: Ryan Cordell
permalink: /research/student-centered-AI
layout: post
---

The following are my remarks as a respondent to papers by [Kathi Inman Berens](https://kathiiberens.com/), [Brian Croxall](https://briancroxall.net/), and [Matthew Kollmer](https://matthewkollmer.com/) for the "Student-Centered AI & DH Practices" roundtable at MLA 2026. Some was written ahead of the panel, and some during the panelists' talks, so forgive its informality.
...
1. stealing the work of artists and thinkers
2. hallucinating ideas and sources
3. leading to cognitive offloading and learning loss
4. damaging the environment
5. exacerbating lonliness or mental illness
6. and so on
...
As the semester went on and we discussed more and more, it became clear that every student—with one notable exception—regularly used of AI tools of various kinds. They would _never_ use it to write a paper for English—_of course!_—but to generate some code for an assignment in statistics? Well, they weren't programmers and that seemed perfectly acceptable. Painting with a broad brush, what emerged was that students saw their own use of AI as _limited_, _reasonable_, and _well-considered_, while they often saw others' uses as _excessive_, _reckless_, and _thoughtless_. For what it is worth, I see some of these same trends echoed in my colleagues, whose comfort with particular applications of AI tracks to their own priorities and values: e.g. it's terrible for writing but fine for code, &c.
